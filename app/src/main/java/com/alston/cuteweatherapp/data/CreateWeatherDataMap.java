...
import com.alston.cuteweatherapp.SevenDaysWeatherData;
import com.alston.cuteweatherapp.data.sevenDaysPrediction.weatherData.Time;
...
public class CreateWeatherDataMap {
    ...
    public static ArrayList<Integer> getWeatheIconsId() {
        return weatheIconsId;
    }
    ...
    public static ArrayList<ForecastData> createOneWeekWeatherData(predictWeatherData wStatus){
        List<WeatherElement> wlist = wStatus.
                                    getRecords().
                                    getLocations().get(0).
                                    getLocation().get(0).
                                    getWeatherElement();
